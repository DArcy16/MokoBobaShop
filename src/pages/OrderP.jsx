        ...
        <div className="container md:w-3/4 mx-auto items-center p-4 space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="table table-zebra w-2/3 mx-auto text-center items-center">
               ...
               { isLoading &&
                  <div className="flex ml-20 sm:ml-32 md:ml-96 h-24 mx-auto items-center">
                  <span className="animate-ping absolute inline-flex h-6 w-24 md:h-8 md:w-36 rounded-full bg-amber-300 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-4 w-24 md:h-6 md:w-36 bg-amber-300 opacity-40"></span>
                  </div>}
